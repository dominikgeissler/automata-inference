...
def test_weighted_union_parameter_zero():
    ...
    aut1 = PGAFactory.dirac("X", 3)
    aut2 = PGAFactory.geometric("Y", Rational(1,3))

    # Left side has weight 0, right has weight one
    actual = minimize(aut1.weighted_union(aut2, 0, 1))
    ...
    actual = minimize(aut1.weighted_union(aut2, 1, 0))
    expected = aut1
    ...
    actual = minimize(aut1.weighted_union(aut2, 0, 0))
